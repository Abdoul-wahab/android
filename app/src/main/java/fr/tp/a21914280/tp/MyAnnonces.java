...
public class MyAnnonces extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.my_annonce_page);
      ...
      //rédirection vers la page d'ajout d'une image
    public void pageAddImg(View view){
    ...
    public void apiCall(String id) {
        ...
        apiResponseCall.enqueue(new retrofit2.Callback<ResponseAPI>() {
            ...
            public void onFailure(retrofit2.Call<ResponseAPI> call, Throwable t) {
                toastMessage("Une erreur s'est produit !");
            }
        });
